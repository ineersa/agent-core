...
1. Model emits tool calls (all tools use flat provider arguments — typed
   built-ins expose DTO fields at the top level; raw dynamic tools keep their
   flat runtime schema map).
