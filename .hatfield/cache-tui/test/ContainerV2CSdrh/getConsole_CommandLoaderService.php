 ...
 */
class getConsole_CommandLoaderService extends Ineersa_CodingAgent_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'Ineersa\\CodingAgent\\CLI\\AgentCommand.command' => ['privates', '.Ineersa\\CodingAgent\\CLI\\AgentCommand.command.lazy', 'getAgentCommand_Command_LazyService', true],
            'Ineersa\\CodingAgent\\CLI\\Auth\\CodexAuthCommand.command' => ['privates', '.Ineersa\\CodingAgent\\CLI\\Auth\\CodexAuthCommand.command.lazy', 'getCodexAuthCommand_Command_LazyService', true],
            'Ineersa\\CodingAgent\\CLI\\CompletionFileIndexRefreshCommand' => ['privates', '.Ineersa\\CodingAgent\\CLI\\CompletionFileIndexRefreshCommand.lazy', 'getCompletionFileIndexRefreshCommand_LazyService', true],
            'Ineersa\\CodingAgent\\CLI\\Log\\LogClearCommand.command' => ['privates', '.Ineersa\\CodingAgent\\CLI\\Log\\LogClearCommand.command.lazy', 'getLogClearCommand_Command_LazyService', true],
            'Ineersa\\CodingAgent\\CLI\\Log\\LogFilesCommand.command' => ['privates', '.Ineersa\\CodingAgent\\CLI\\Log\\LogFilesCommand.command.lazy', 'getLogFilesCommand_Command_LazyService', true],
            'Ineersa\\CodingAgent\\CLI\\Log\\LogSearchCommand.command' => ['privates', '.Ineersa\\CodingAgent\\CLI\\Log\\LogSearchCommand.command.lazy', 'getLogSearchCommand_Command_LazyService', true],
            'Ineersa\\CodingAgent\\CLI\\Log\\LogTailCommand.command' => ['privates', '.Ineersa\\CodingAgent\\CLI\\Log\\LogTailCommand.command.lazy', 'getLogTailCommand_Command_LazyService', true],
