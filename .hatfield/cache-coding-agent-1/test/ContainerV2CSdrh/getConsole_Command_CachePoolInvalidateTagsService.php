 ...
 */
class getConsole_Command_CachePoolInvalidateTagsService extends Ineersa_CodingAgent_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_invalidate_tags'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolInvalidateTagsCommand(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'cache.default' => ['privates', '.cache.default.taggable', 'get_Cache_Default_TaggableService', true],
        ], [
            ...
            'cache.default' => 'Symfony\\Component\\Cache\\Adapter\\TagAwareAdapter',
        ]));
