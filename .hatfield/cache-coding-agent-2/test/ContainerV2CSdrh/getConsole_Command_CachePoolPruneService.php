 ...
 */
class getConsole_Command_CachePoolPruneService extends Ineersa_CodingAgent_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'cache.default' => ($container->privates['cache.default'] ?? $container->load('getCache_DefaultService'));
        }, 4));
