...
The task board root is configured via `extensions.settings.task_workflow.task_root` in Hatfield settings, or overridden by the `HATFIELD_TASK_WORKFLOW_ROOT` environment variable.
