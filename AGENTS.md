...
- `config/bundles.php` registers `ConsoleBundle`; `ServicesBundle` comes through required bundles.
- Do not add `FrameworkBundle`, `HttpKernel`, `public/index.php`, HTTP stack, router, or FrameworkBundle-only config.
