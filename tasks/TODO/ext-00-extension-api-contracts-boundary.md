...
## Acceptance criteria
- `src/CodingAgent/ExtensionApi/` contains the initial public contracts/value objects: `HatfieldExtensionInterface`, `ExtensionApiInterface`, `ToolRegistrationDTO`, and tool scope enum/value as designed in the plan.
