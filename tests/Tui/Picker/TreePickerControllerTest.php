...
final class TreePickerControllerTest extends TestCase
{
    ...
    public function testBuildItemsLinearTree(): void
    {
        ...
        self::assertStringContainsString('◉ ', $items[1]['label']);
    ...
    public function testBuildItemsMarksCurrentLeaf(): void
    {
        ...
        self::assertStringContainsString('◉ ', $items[2]['label']);
    ...
    public function testBuildItemsLinearContinuationInsideBranchDoesNotStaircase(): void
    {
        ...
        self::assertStringContainsString('│  └─ ○ ', $items[2]['label']);
        self::assertStringContainsString('│     ○ ', $items[3]['label']);
        self::assertStringContainsString('│     ◉ ', $items[4]['label']);
        self::assertStringContainsString('└─ ○ ', $items[5]['label']);
    ...
    public function testBuildItemsRewindBranchTreeAUserOracle(): void
    {
        ...
        self::assertStringContainsString('assistant: Hello!', $items[0]['label']);
        self::assertStringContainsString('Secret word is pineapple', $items[1]['label']);
        self::assertStringContainsString('What is secret word', $items[2]['label']);
        self::assertStringContainsString('secret word straw', $items[3]['label']);
        self::assertStringContainsString('secret word is apple', $items[4]['label']);
    }
    ...
    public function testBuildItemsRewindBranchTreeBUserOracleWithForkAtTurn2(): void
    {
        ...
        self::assertStringContainsString('What is secret word', $items[2]['label']);
        self::assertStringContainsString('secret word straw', $items[3]['label']);
        self::assertStringContainsString('secret word kale', $items[4]['label']);
        self::assertStringContainsString('secret word is apple', $items[5]['label']);
    }
