...
",
    ...
    public function testUserAgentsOverridesUserHatfield(): void
    {
        ...
        self::assertNotNull($definition);
        self::assertSame('User-agents version', $definition->description);
    }
    ...
    public function testProjectHatfieldOverridesUser(): void
    {
        ...
        self::assertNotNull($definition);
        self::assertSame('Project version', $definition->description);
    }
    ...
    public function testProjectAgentsOverridesProjectHatfield(): void
    {
        ...
        self::assertNotNull($definition);
        self::assertSame('Project-agents version', $definition->description);
    }
    ...
    public function testConfiguredPathsHaveHighestPrecedence(): void
    {
        ...
        self::assertNotNull($definition);
        self::assertSame('Configured-path version', $definition->description);
    }
    ...
    public function testConfiguredMissingPathProducesDiagnostic(): void
    {
        ...
        self::assertSame('missing_path', $diagnostics[0]->type);
    ...
    public function testInvalidDefinitionProducesDiagnostic(): void
    {
        ...
        self::assertNull($catalog->get('bad'));
        ...
        self::assertTrue($hasInvalidDef, 'Expected an invalid_definition diagnostic');
    }
    ...
    public function testOverrideProducesCollisionDiagnostic(): void
    {
        ...
        self::assertNotNull($definition);
        self::assertSame('Higher precedence', $definition->description);
        ...
        foreach ($catalog->diagnostics() as $d) {
            if ('collision' === $d->type && 'collide' === $d->name) {
                $hasCollision = true;
                self::assertNotEmpty($d->winnerPath);
                self::assertNotEmpty($d->loserPath);
                break;
            }
        }
        self::assertTrue($hasCollision, 'Expected a collision diagnostic for "collide"');
    }
    ...
    public function testDisabledDefinitionStillInAllAndDisabled(): void
    {
        ...
        self::assertNotNull($catalog->get('disabled-agent'));
        ...
        self::assertContains('disabled-agent', $allNames);
        self::assertContains('disabled-agent', $disabledNames);
        self::assertNotContains('disabled-agent', $enabledNames);
    }
