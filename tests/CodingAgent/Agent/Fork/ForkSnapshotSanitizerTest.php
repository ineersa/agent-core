...
final class ForkSnapshotSanitizerTest extends TestCase
{
    ...
    public function testSanitizeRemovesLaunchMessages(): void
    {
        ...
        $this->assertSame('Earlier conversation', $result[0]->content[0]['text']);
        $this->assertSame('Earlier response', $result[1]->content[0]['text']);
    }
    ...
    public function testSanitizeNoForkCallReturnsUnchanged(): void
    {
        ...
        $this->assertSame($messages[0]->content[0]['text'], $result[0]->content[0]['text']);
        $this->assertSame($messages[1]->content[0]['text'], $result[1]->content[0]['text']);
        $this->assertSame($messages[2]->content[0]['text'], $result[2]->content[0]['text']);
    }
    ...
    public function testSanitizeDoesNotMutateInput(): void
    {
        ...
        $this->assertSame($originalContent, $messages[0]->content[0]['text']);
    }
    ...
    public function testSanitizeOnlyLastForkCallIsChecked(): void
    {
        ...
        $this->assertCount(2, $result);
        $this->assertSame('Earlier', $result[0]->content[0]['text']);
    }
    ...
    public function testSanitizeWithMixedToolCallsIncludingFork(): void
    {
        ...
        $this->assertCount(2, $result);
        $this->assertSame('Earlier conversation 1', $result[0]->content[0]['text']);
        $this->assertSame('Response 1', $result[1]->content[0]['text']);
    }
