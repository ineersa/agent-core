...
final class SubagentExecutionServiceTest extends IsolatedKernelTestCase
{
    public function testNestedSubagentLaunchBlockedWhenParentIsAgentChild(): void
    {
        ...
        $service = $this->makeService([
            ...
            'committedRunEventAppender' => new SubagentProgressEventAppender(self::getContainer()->get(CommittedRunEventAppender::class), self::getContainer()->get(\Ineersa\CodingAgent\Runtime\Contract\SubagentProgress\SubagentProgressSnapshotCodec::class)),
