...
final class SafeGuardPathMatcherTest extends TestCase
{
    ...
    {
        self::assertSame($expected, $this->matcher->isInsideCwd($cwd, $path));
    }
    ...
    {
        self::assertSame($expected, $this->matcher->isPathInList($patterns, $path));
    }
    ...
    public function testIsProtectedReadPath(array $patterns, string $path, bool $expected): void
    {
        ...
        self::assertSame($expected, $this->matcher->isProtectedReadPath($policy, $path));
    }
    ...
    public function testDefaultPatternsListIsNotEmpty(): void
    {
        ...
        self::assertGreaterThan(20, \count($defaults));
    }
}
