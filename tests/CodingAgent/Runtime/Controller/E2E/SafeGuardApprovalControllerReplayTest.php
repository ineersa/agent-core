 ...
 *
 * Exact-call continuation after Allow (no silent drop of the terminal ToolCallResult)
 * is the unique controller-transport proof retained here. Multi-edit independent
 * approval is covered by SafeGuard unit/policy + the single Allow path below.
 */
...
final class SafeGuardApprovalControllerReplayTest extends ControllerReplayE2eTestCase
{
    ...
    public function testWriteOutsideCwdAllowViaCanonicalHumanInput(): void
    {
        ...
        $preAnswerEvents = $this->collectEventsUntil('human_input.requested', 12.0);
        ...
        $postEvents = $this->collectEventsUntilToolCompleted('write', 15.0);
