        ...
        return [
            ...
            [
                ...
                'deltas' => [
                    ...
                    ['type' => 'tool_input_delta', 'id' => 'call_age_1', 'name' => 'read', 'partial_json' => '{"argu'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_1', 'name' => 'read', 'partial_json' => 'ments'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_1', 'name' => 'read', 'partial_json' => '":{"p'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_1', 'name' => 'read', 'partial_json' => 'ath":'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_1', 'name' => 'read', 'partial_json' => '"./no'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_1', 'name' => 'read', 'partial_json' => 'tes.t'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_1', 'name' => 'read', 'partial_json' => 'xt"}}'],
                    ['type' => 'tool_call_start', 'id' => 'call_age_2', 'name' => 'bash'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => '{"argu'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => 'ments"'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => ':{"com'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => 'mand"'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => ':"ech'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => 'o too'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => 'l-cyc'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => 'le te'],
                    ['type' => 'tool_input_delta', 'id' => 'call_age_2', 'name' => 'bash', 'partial_json' => 'st"}}'],
                    ['type' => 'tool_call_complete', 'tool_calls' => [
                        ['id' => 'call_age_1', 'name' => 'read', 'arguments' => ['arguments' => ['path' => './notes.txt']]],
                        ['id' => 'call_age_2', 'name' => 'bash', 'arguments' => ['arguments' => ['command' => 'echo tool-cycle test']]],
                    ]],
                ],
                'usage' => [
                    'input_tokens' => 5000,
