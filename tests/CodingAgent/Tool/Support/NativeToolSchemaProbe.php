 ...
 *
 * Typed DTO tools with null parametersJsonSchema yield the flat DTO-field
 * schema generated by Symfony AI's JsonSchema Factory. Tools with an
 * explicit parametersJsonSchema (typed or raw) yield that flat schema.
 *
