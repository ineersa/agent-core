 ...
 * object schema hoisted to the Tool root) generated by Symfony AI's
 * ReflectionToolFactory; raw tools yield their flat runtime schema.
 *
...
final class NativeToolSchemaProbe
{
    ...
    public static function for(HatfieldToolProviderInterface $provider): array
    {
        $toolbox = new RegistryBackedToolbox(
            ...
            nativeToolFactory: self::nativeToolFactory(),
        );
    ...
    /**
     * Provider-aware native metadata factory mirroring config/services.yaml.
     *
     ...
     */
    public static function nativeToolFactory(): ReflectionToolFactory
    {
        return new ReflectionToolFactory(new Factory(new Describer([
