...
final class RegistryBackedToolboxTest extends TestCase
{
    ...
    public function testExecuteDispatchesSymfonyAiToolFailedEvent(): void
    {
        ...
        try {
            ...
            $this->fail('Expected handler exception to be re-thrown as ToolExecutionException.');
        } catch (ToolExecutionException $caught) {
        ...
        $this->assertSame(['arguments' => ['path' => 'x']], $failedEvent->getArguments());
        // Lifecycle event sees the original handler exception; outer throw wraps for FaultTolerantToolbox.
