...
final class AiHttpConfigTest extends TestCase
{
    ...
    public function testFromArrayEmptyProducesAllNullFields(): void
    {
        ...
        self::assertNull($config->maxDuration);
        self::assertNull($config->maxRetries);
        self::assertNull($config->baseDelayMs);
        self::assertNull($config->maxDelayMs);
    }
    ...
    public function testFromArrayParsesExplicitInts(): void
    {
        ...
        self::assertSame(120, $config->maxDuration);
        self::assertSame(5, $config->maxRetries);
        self::assertSame(2000, $config->baseDelayMs);
        self::assertSame(120_000, $config->maxDelayMs);
    }
    ...
    public function testFromArrayParsesIndividualKeysIndependently(): void
    {
        ...
        self::assertSame(15, $config->timeout);
        self::assertNull($config->maxDuration);
        self::assertNull($config->maxRetries);
        self::assertNull($config->baseDelayMs);
        self::assertNull($config->maxDelayMs);
    ...
    public function testFromArrayResolvesEnvVarForAllKeys(): void
    {
        ...
        try {
            ...
            self::assertSame(8, $config->timeout);
            self::assertSame(60, $config->maxDuration);
    ...
    public function testAiConfigFromArrayPassesHttpBlock(): void
    {
        ...
        self::assertSame(7, $config->http->timeout);
        self::assertSame(0, $config->http->maxRetries);
        self::assertNull($config->http->maxDuration);
        self::assertNull($config->http->baseDelayMs);
        self::assertNull($config->http->maxDelayMs);
    }
    ...
    public function testAiConfigFromArrayDefaultsHttpToEmpty(): void
    {
        ...
        self::assertNotNull($config->http);
        self::assertNull($config->http->timeout);
        self::assertNull($config->http->maxRetries);
    }
}
