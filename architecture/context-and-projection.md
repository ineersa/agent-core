...
At the terminal output boundary, Symfony TUI's stock `ScreenWriter` hides
the hardware cursor during repaints and restores cursor state before releasing
synchronized output. See
