 ...
 *
 * Dispatched back to agent.command.bus and routed to run_control
 * (native PhpSerializer) so the single run_control consumer applies state
 * mutations. Nested {@see AgentMessage} retained-tail objects travel as
 * typed values — do not flatten them to associative arrays.
 *
 * The result handler validates staleness, processes the summary text, and
 * emits either context_compacted or context_compaction_failed.
 */
