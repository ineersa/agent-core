...
final class ForkToolDefinitionBuilder
{
    public static function build(ToolHandlerInterface $handler): ToolDefinitionDTO
    {
        return new ToolDefinitionDTO(
            name: 'fork',
            description: 'Launch an interactive fork child with inherited compacted parent history. Returns immediately while the child runs in the background. Use /agents-live to monitor; use agent_retrieve for handoff/metadata after completion.',
            ...
            timeoutSeconds: null,
            promptLine: 'fork task="..." [level=junior|middle|senior] — launch background fork child with inherited history',
            promptGuidelines: [
