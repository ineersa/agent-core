 ...
 * shapes exist:
 * - Typed DTO handlers (built-ins, declared with Symfony AI #[AsTool]):
 *   parametersJsonSchema is null and the provider schema is generated
 *   natively from the method parameter type and DTO constraints.
