...
3. **Toolbox + settings foundation:** TOOLS-R03 (registry-backed Toolbox + allowlist + ToolRuntime docs) runs after TOOLS-R02. TOOLS-R04 is a closeout verification that common settings are already typed and future concrete-tool settings are deferred to concrete tool tasks. Concrete tools need TOOLS-R03 for actual execution through the Symfony AI pipeline. TOOLS-R05 starts after TOOLS-R03 + TOOLS-R04 + TOOLS-00 when the execution, settings, and cancellation primitives are stable.
