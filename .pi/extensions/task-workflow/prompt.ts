...
- Use move_task with to="CANCELLED" from any status to abandon a task. Clean worktrees and IDEA exclusions are removed safely; dirty worktrees fail closed without moving the task; the git branch is left in place.
