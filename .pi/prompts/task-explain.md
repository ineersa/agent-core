...
Load if not loaded yet `task-workflow` skill and follow the `task-explain` phase. This phase is read-only: present the plan for discussion and stop before implementation.
